...
- `out private.pem` indicates the name of the output file where the private key will be saved in PEM format
...
- `out public.pem` specifies the name of the output file where the public key will also be saved in PEM format
```bash
