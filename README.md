...
- `out private.pem` indicates the name of the output file (in this case we went with "private") where the private key will be saved in PEM (Privacy-Enhanced Mail) format
